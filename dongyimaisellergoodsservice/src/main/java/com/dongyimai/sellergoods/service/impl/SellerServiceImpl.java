...
//更改商家状态
    ...
    TbSeller seller=sellerMapper.selectByPrimaryKey(sellerId);//根据主键查找seller信息，将它封装在seller中
    seller.setStatus(status);//修改selleer中status状态值
    sellerMapper.updateByPrimaryKey(seller);//调用方法实现修改
	}
